...
- **Low-barrier contributions**: The [web editor](/editor/overview) and [agent](/agent/overview) let anyone on your team update content without learning Git or Markdown.
...
The [agent](/agent/overview) in your dashboard creates documentation updates from natural language prompts. Describe what you want to change, and the agent creates a pull request with the updates.
