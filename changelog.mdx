...
<Update label="February 27, 2026" tags={["New releases", "Improvements"]} rss={{ title: "Automate documentation tasks with workflows and collaborate in the editor with comments and suggestions" }}>
  ...
  Automate documentation tasks with [workflows](/agent/workflows). Set up scheduled or event-triggered automations that run the agent to update your documentation.
  ...
  Collaborate directly in the web editor with [comments](/editor/comments) and [suggestions](/editor/suggestions). Select text to leave feedback, mention teammates, or suggest changes.
...
<Update label="December 23, 2025" tags={["New releases", "Improvements"]} rss={{ title: "Web editor improvements and assistant insights" }}>
  ...
  The [web editor](/editor/overview) now has a more intuitive interface and new capabilities.
